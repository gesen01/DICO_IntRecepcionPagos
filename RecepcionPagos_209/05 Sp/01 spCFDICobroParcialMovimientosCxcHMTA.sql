...
/******************************* spCFDICobroParcialMovimientosCxcHMTA *************************************************/
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('dbo.spCFDICobroParcialMovimientosCxcHMTA') AND TYPE = 'P')
DROP PROCEDURE spCFDICobroParcialMovimientosCxcHMTA
GO
